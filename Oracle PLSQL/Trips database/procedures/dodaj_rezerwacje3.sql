create or replace procedure dodaj_rezerwacje3(id_wycieczki int, id_osoby int)
as
    person_exists int;
    trip_avaliable int;
...
begin
    ...
    select count(*) into person_exists from OSOBY o where o.ID_OSOBY = dodaj_rezerwacje3.id_osoby;
    ...
    where WYCIECZKIDOSTEPNE.id_wycieczki = dodaj_rezerwacje3.id_wycieczki;
    ...
    if trip_avaliable = 0 then
     ...
     from REZERWACJE r
     where r.ID_OSOBY = dodaj_rezerwacje3.id_osoby
        and r.ID_WYCIECZKI = dodaj_rezerwacje3.id_wycieczki
        and r.STATUS <> 'A';
